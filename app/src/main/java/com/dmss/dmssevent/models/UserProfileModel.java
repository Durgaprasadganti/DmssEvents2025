...
public class UserProfileModel {
    String EmailID = "", EmpGuid = "", EmpID = "", FirstName = "", LastName = "", CommonName = "", DisplayName = "", ManagerGuid = "", JobTittle = "", BuisnessUnit = "", Department = "",
            UserRole = "", OfficePhone = "", Mobile = "",ProfilePhoto="",ProfileImageURL="";
    int Id,SportsFightId;
    ...
    public UserProfileModel(JSONObject userProfileResult) {
        try {
            ...
            SportsFightId = userProfileResult.isNull("SportsFightId") ? 0 : userProfileResult.getInt("SportsFightId");
            ...
            ProfileImageURL = userProfileResult.isNull("ProfileImageURL") ? "" : userProfileResult.getString("ProfileImageURL");
    ...
    public int getSportsFightId() {
        return SportsFightId;
    }

    public void setSportsFightId(int sportsFightId) {
        SportsFightId = sportsFightId;
    }
}
