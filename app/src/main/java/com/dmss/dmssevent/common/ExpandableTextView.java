...
public class ExpandableTextView extends TextView
{
    ...
    public ExpandableTextView(final Context context, @Nullable final AttributeSet attrs, final int defStyle)
    {
        ...
        // read attributes
        final TypedArray attributes = context.obtainStyledAttributes(attrs, R.styleable.ExpandableTextView1, defStyle, 0);
        this.animationDuration = attributes.getInt(R.styleable.ExpandableTextView1_animation_duration, DEFAULT_TRIM_LENGTH);
        attributes.recycle();
