...
public class AwardsAdapter extends BaseAdapter {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (awardsModelArrayList.get(position).getRewards() != null && awardsModelArrayList.get(position).getDescription() != null) {
            ...
            if (awardsModelArrayList.get(position).getRewards().equalsIgnoreCase("-")) {
                holder.textViewAvgRating.setText("NA");
            } else {
                holder.textViewAvgRating.setText(awardsModelArrayList.get(position).getRewards());
            }


        } else if (awardsModelArrayList.get(position).getDescription() == null || awardsModelArrayList.get(position).getDescription().equalsIgnoreCase("-")) {
    ...
    private void awardsDialogMain(final int position) {
        ...
        textViewHeading.setText(awardsModelArrayList.get(position).getAwardName());
        textViewDescription.setText(awardsModelArrayList.get(position).getDescription());
        if (awardsModelArrayList.get(position).getCriteria().equalsIgnoreCase("-")) {
            textViewCreteria.setText("No Data");
        } else {
            textViewCreteria.setText(awardsModelArrayList.get(position).getCriteria());
        }
    ...
    public class Holder {
        TextView textViewEventHeading, textViewDetail, textViewVotes, textViewAvgRating, textViewAvg, descTextView;
