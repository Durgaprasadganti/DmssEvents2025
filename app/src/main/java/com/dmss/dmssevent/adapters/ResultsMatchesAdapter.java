...
public class ResultsMatchesAdapter extends BaseAdapter {
    Context context;
    ArrayList<ResultListGamesModel> resultListGamesModelArrayList;
    Date dt;
    public ResultsMatchesAdapter(Context context, ArrayList<ResultListGamesModel> resultListGamesModelArrayList) {
    ...
    @Override
    public int getCount() {
        return resultListGamesModelArrayList.size();
    }
    ...
    public long getItemId(int position) {
        return resultListGamesModelArrayList.hashCode();
    }
    ...
    public View getView(int position, View convertView, ViewGroup viewGroup) {
       ...
       // holder.textViewMatchNumber.setText("Match "+resultListGamesModelArrayList.get(position).getId());
        holder.textViewMatchNumber.setVisibility(View.GONE);
        holder.textViewTeamA.setText(resultListGamesModelArrayList.get(position).getTeamA());
        holder.textViewTeamB.setText(resultListGamesModelArrayList.get(position).getTeamB());
       ...
       // Glide.with(context).load(ConstantKeys.getImageUrl + resultListGamesModelArrayList.get(position).getPlayer1Logo()).apply(options).into(holder.imageViewGamesIconA);

       // Glide.with(context).load(ConstantKeys.getImageUrl + resultListGamesModelArrayList.get(position).getPlayer2Logo()).apply(options).into(holder.imageViewGamesIconB);


        Glide.with(context).load(ConstantKeys.getImageUrl + resultListGamesModelArrayList.get(position).getPlayer1Logo()).apply(RequestOptions.circleCropTransform()).into(holder.imageViewGamesIconA);
        Glide.with(context).load(ConstantKeys.getImageUrl + resultListGamesModelArrayList.get(position).getPlayer2Logo()).apply(RequestOptions.circleCropTransform()).into(holder.imageViewGamesIconB);

        String[] str_array = resultListGamesModelArrayList.get(position).getScheduleDate().split("T");
        if(str_array.length>0) {
            ...
            //String startTime = resultListGamesModelArrayList.get(position).getScheduleDate().replace("T"," ");
/*if(startTime.length()>0){


        String startTe = resultListGamesModelArrayList.get(position).getScheduleTime();
        ...
        String winnerName=resultListGamesModelArrayList.get(position).getWinningPlayer().trim();
        String player1=resultListGamesModelArrayList.get(position).getPlayer1().trim();
        String player2=resultListGamesModelArrayList.get(position).getPlayer2().trim();
        if(winnerName.equalsIgnoreCase(player1)){
            holder.imageViewWinner1.setVisibility(View.VISIBLE);
            holder.imageViewWinner2.setVisibility(View.GONE);
        }else if(winnerName.equalsIgnoreCase(player2)){
        ...
        if(!resultListGamesModelArrayList.get(position).getMatchType().equalsIgnoreCase("")){
            holder.textViewGameType.setText(resultListGamesModelArrayList.get(position).getMatchType());
        }else{
            holder.textViewGameType.setVisibility(View.GONE);
        }
        holder.textViewTime.setText(resultListGamesModelArrayList.get(position).getScheduleTime());
        holder.textViewPlayer1.setText(resultListGamesModelArrayList.get(position).getPlayer1());
        holder.textViewPlayer2.setText(resultListGamesModelArrayList.get(position).getPlayer2());
        holder.textViewGameName.setText(resultListGamesModelArrayList.get(position).getGame());
        holder.textViewGameSingles.setText(resultListGamesModelArrayList.get(position).getGameType());
        holder.textViewMatchNumberD.setText(resultListGamesModelArrayList.get(position).getMatchNo());
        ...
        for (int i = 0; i < resultListGamesModelArrayList.size(); i++) {
