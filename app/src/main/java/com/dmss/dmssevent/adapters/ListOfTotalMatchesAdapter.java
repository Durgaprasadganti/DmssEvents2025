...
public class ListOfTotalMatchesAdapter extends BaseAdapter {
    Context context;
    ArrayList<TodaySinglesListModel> todayListModelArraySinglesList;
    int matchValue;
    public ListOfTotalMatchesAdapter(Context context, ArrayList<TodaySinglesListModel> todayListModelArraySinglesList) {
