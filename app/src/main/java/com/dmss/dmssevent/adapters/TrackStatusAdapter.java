...
public class TrackStatusAdapter extends RecyclerView.Adapter<TrackStatusAdapter.ViewHolder> {
    ...
    private ArrayList<TrackStatus> mData;
    private LayoutInflater mInflater;
    private ItemClickListener mClickListener;

    // data is passed into the constructor
    public TrackStatusAdapter(Context context, ArrayList<TrackStatus> data) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = mInflater.inflate(R.layout.track_status_adapter, parent, false);
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        String animal = mData.get(position).getDate();
